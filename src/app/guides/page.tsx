...
export const metadata: Metadata = {
  ...
  ...socialMetadata(
    'Distant Horizons Mod Troubleshooting Guides',
    'Practical, version-aware guides for Distant Horizons performance, shaders, RAM, LOD generation, crashes, and installation problems.',
    '/guides',
  ),
};
