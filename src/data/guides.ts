...
export const guides: Guide[] = [
  {
    ...
    steps: [
      ...
      { title: 'Identify generation load', body: 'Compare an already-generated area with unexplored terrain. High CPU use that settles after LOD building is different from constant stutter in an area whose LODs are already complete.' },
      { title: 'Reduce DH building threads', body: 'Use no more than roughly half your logical CPU threads as an initial ceiling for LOD building. Reduce the value further if mouse input or the game thread stalls while exploring.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Distinguish heap pressure from a leak', body: 'If memory rises during generation and later falls, garbage collection is working. If it never recovers, reproduce the issue in a clean profile and record the latest log before increasing the heap again.' },
      { title: 'Read the first memory error', body: 'An out-of-memory crash, repeated allocation failure, and long garbage-collection pause are different failure modes. Keep the crash report and note the heap size, LOD distance, shaders, resource packs, and mod list.' },
    ],
    related: ['distant-horizons-low-fps', 'distant-horizons-chunks-not-loading'],
  },
  {
    ...
    related: ['distant-horizons-shader-not-working', 'distant-horizons-chunks-not-loading'],
  },
  {
  ...
  },
  {
    ...
    description: 'Safely rebuild stale, corrupted, or wrong-dimension Distant Horizons LOD data after changing versions, servers, dimensions, resource packs, or world-generation mods.', category: 'Troubleshooting', updated: '2026-09-20',
    ...
    symptoms: ['old terrain remains after an update', 'LOD colors do not match the resource pack', 'the Nether or End shows terrain from another profile', 'generation works in a new world but not the old one'],
    steps: [
      ...
      { title: 'Confirm the world and dimension identity', body: 'Record the instance, save name, server address and port, and affected dimension. A changed server identity or reused profile can make valid LOD data appear to belong to the wrong world.' },
    ...
    ], related: ['distant-horizons-chunks-not-loading', 'distant-horizons-chunk-flickering'],
  },
  {
    ...
    ], related: ['distant-horizons-chunks-not-loading', 'distant-horizons-lod-cache-reset'],
  },
  {
    slug: 'distant-horizons-chunks-not-loading', title: 'Distant Horizons Chunks Not Loading: Fix Empty Horizons',
    description: 'Fix empty horizons, missing LOD chunks, paused generation, and slow distant-terrain building with a clear client and server checklist.', category: 'Troubleshooting', updated: '2026-09-20',
    ...
    steps: [
      ...
      { title: 'Separate rendering from generation', body: 'If existing LODs render but new terrain never appears, focus on generation and chunk delivery. If no LODs render anywhere, check the renderer, profile, and shader stack first.' },
      ...
      { title: 'Compare local and multiplayer worlds', body: 'If the same profile works in single-player, the multiplayer issue may be server view distance, chunk delivery, request limits, or a server/client version mismatch rather than a local render setting.' },
    ...
    ], related: ['distant-horizons-server-realms', 'distant-horizons-lod-cache-reset'],
  },
  {
  ...
  },
  {
    ...
    ], related: ['distant-horizons-how-to-use', 'distant-horizons-fabric-vs-neoforge'],
  },
  {
    ...
    ], related: ['distant-horizons-chunks-not-loading', 'distant-horizons-best-settings-laptop'],
  },
  {
